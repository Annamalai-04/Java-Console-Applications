...
public class user {
    ...
    public void transaction(Object[] a1,Object[] a2,Object[] a3,int id,String n,String p,int amt,String dt,Object iamt) throws Exception{
       ...
       System.out.println();
        for (Object entry : dp.entrySet()) {
            ...
            System.out.println("DateTime: " + key + ", UserID: " + values.getValue1() + ", Amount Deposited: " + values.getValue2());
            }
        }
        System.out.println();
        ...
        for (Object entry : wd.entrySet()) {
            ...
            ThreeValues values = typedEntry.getValue();
            if(values.getValue1()==id){
            System.out.println("DateTime: " + key + ", UserID: " + values.getValue1() + ", Amount Withdrawals: " + values.getValue2());
            }
        }
        this.menu(a1, a2,a3, id, n, p,amt,dt,iamt);
}
  ...
  public void menu(Object[] a1,Object[] a2,Object[] a3,int id,String n,String p,int amt,String dt,Object iamt) throws Exception{
    ...
    System.out.println("5. for EXIT Current User");
    System.out.println("6. for EXIT Bank");
    System.out.println("--------------------------------------------------------");
    System.out.println();
    ...
    switch (ch) {
        ...
        case 5:System.out.println("*******************Thankyou "+n+" *****************************");
               bank obj=new bank();
               obj.display(a1,a2,a3,amt,dt,iamt);
                break;
        default:System.out.println("*******************Thankyou for using our bank*****************************");
               break;
